...
public class DomainNameNormalizer {
    ...
    private static final List<DomainVocabulary> VOCABULARIES = List.of(
            ...
            new DomainVocabulary("問い合わせ管理", "inquiries", "Inquiry"),
            new DomainVocabulary("営業案件管理", "opportunities", "Opportunity"),
            new DomainVocabulary("契約請求管理", "contracts", "Contract"),
            new DomainVocabulary("契約管理", "contracts", "Contract"),
            new DomainVocabulary("請求管理", "invoices", "Invoice"),
            new DomainVocabulary("決済管理", "payments", "Payment"),
            new DomainVocabulary("承認ワークフロー", "approval-workflows", "ApprovalWorkflow"),
            new DomainVocabulary("承認依頼", "approval-requests", "ApprovalRequest"),
            new DomainVocabulary("監査ログ管理", "audit-logs", "AuditLog"),
            new DomainVocabulary("監査ログ", "audit-logs", "AuditLog"),
            new DomainVocabulary("通知管理", "notifications", "Notification"),
            new DomainVocabulary("通知", "notifications", "Notification"),
            ...
            new DomainVocabulary("問い合わせ", "inquiries", "Inquiry"),
            new DomainVocabulary("外部共有リンク", "external-share-links", "ExternalShareLink"),
            new DomainVocabulary("顧客管理", "customers", "Customer"),
            new DomainVocabulary("顧客", "customers", "Customer"),
            new DomainVocabulary("商談", "opportunities", "Opportunity"),
            new DomainVocabulary("見積", "quotes", "Quote"),
            new DomainVocabulary("契約", "contracts", "Contract"),
            new DomainVocabulary("請求", "invoices", "Invoice"),
            new DomainVocabulary("入金", "payments", "Payment"),
            new DomainVocabulary("決済", "payments", "Payment"),
            new DomainVocabulary("注文管理", "orders", "Order"),
            new DomainVocabulary("注文", "orders", "Order"),
            new DomainVocabulary("在庫管理", "inventory", "Inventory"),
            new DomainVocabulary("在庫品目", "inventory", "Inventory"),
            new DomainVocabulary("在庫", "inventory", "Inventory"),
            new DomainVocabulary("配送管理", "deliveries", "Delivery"),
            new DomainVocabulary("配送", "deliveries", "Delivery"),
            new DomainVocabulary("出荷", "shipments", "Shipment"),
